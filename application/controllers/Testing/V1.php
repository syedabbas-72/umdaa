...
require APPPATH . '/controllers/Testing/V1_1.php';
    ...
    public function book_appointment($parameters, $method, $user_id) {
        ...
        */
        ...
        if(count($checkAppointment) > 0) {
            ...
            $patientSMSContent = "Dear $PName,%nYour Appointment with $DName on $Date @ $Time.%nFrom,%n$CName."; //working
