...
require APPPATH . '/controllers/Api1_V1.php';

class ApiV1 extends Api1_V1 {
        ...
        if(count($docRec) == 0){
            ...
            if($clinic_id == 0)
            {
                ...
                if($FO==1)
                {
                    ...
                    $focred = "<br><br>Below are your credentials for Front Office.<br><br><b>Username:</b>".$inchargeUname."<br><br><b>Password:<b> ".$inchargePwd;
                }
                if($PH==1)
                {
                    ...
                    $emp['modified_date_time']=date('Y-m-d H:i:s');
                    $this->Generic_model->insertData('employees',$emp);
                    $phcred = "<br><br>Below are your credentials for Pharmacy.<br><br><b>Username:</b>".$phUname."<br><br><b>Password:<b> ".$phPwd;
                }
                if($LAB==1)
                {
                    ...
                    $emp['modified_date_time']=date('Y-m-d H:i:s');
                    $this->Generic_model->insertData('employees',$emp);
                    $labcred = "<br><br>Below are your credentials for Lab Technician.<br><br><b>Username:</b>".$labUname."<br><br><b>Password:<b> ".$labPwd;
                }
                if($NU==1)
                {
                    ...
                    $emp['modified_date_time']=date('Y-m-d H:i:s');
                    $this->Generic_model->insertData('employees',$emp);
                    $nucred = "<br><br>Below are your credentials for Nurse.<br><br><b>Username:</b>".$nuUname."<br><br><b>Password:<b> ".$nuPwd;
                }
            ...
            if($clinic_id == 0)
            {
                $message = '<html><link href="https://fonts.googleapis.com/css?family=Roboto&display=swap" rel="stylesheet"><body style="font-family:Roboto; width:100%;padding:20px;"> <div style="width:80%;border:1px solid #bdbdbd;padding:30px;background-color:#fff;border-radius:8px"> <img src="https://umdaa.co/clinic/assets/img/umdaa_clinic_logo.png"> <br><h4>Congratulations! Your Account has been successfully created.<br>You can start using your account from your android mobile using your registered email and password<br>If you Want to use Our Modules Which has been selected by you. <br>For accessing Admin portal You have to check this below link.</h4><br><h4>URL : '.base_url().$focred.$phcred.$labcred.$nucred.'</h4> </div></body></html>';    
            }
            else
            {
                $message = '<html><link href="https://fonts.googleapis.com/css?family=Roboto&display=swap" rel="stylesheet"><body style="font-family:Roboto; width:80%;padding:20px;"> <div style="width:80%;border:1px solid #bdbdbd;padding:30px;background-color:#fff;border-radius:8px"> <img src="https://umdaa.co/clinic/assets/img/umdaa_clinic_logo.png"> <br><h4>Congratulations! Your Account has been successfully created.<br>You can start using your account from your android mobile using your registered email and password </h4> </div></body></html>';
            }
            ...
            //Message To Doctor
            $docSMS = "Dear ".$doctor['full_name']." Welcome to UMDAA Family. Your account has been successfully created. You can log in to our UMDAA App using your registered Mobile Number and Password. Please Check Your Email For Further Information.";
            sendsms($mobile, $docSMS);

            //Message TO Administrator
            $adminMobile = "9100462015";
