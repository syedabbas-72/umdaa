...
class Calendar_view extends CI_Controller
{
    ...
    public function checkblockdates(){
        ...
        foreach ($blockInfo as $value) {
            ...
            <a  class="btn btn-rounded btn-border btn-xs" style="padding: 4px;letter-spacing: normal;border-radius: 3px;border: 1px solid #e0e0e4;padding: 5px;display: inline-block;text-align: center; color: #3a405b;cursor: pointer;">
            ...
            <span class="btn btn-danger btn-xs del_blockDates" onclick="delBlockDate(<?=$value->calendar_blocking_id?>)">
                <i style="color:#FF3636 !important" class="fa fa-trash"></i>
            </span>
...
public function confirm_mobile()
{
    ...
    $patient_info = $this->db->select("*")->from("patients")->where("mobile like '" . $encryptedMobile . "%'")->get();
