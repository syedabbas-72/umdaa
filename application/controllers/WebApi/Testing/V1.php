...
require APPPATH . '/controllers/WebApi/Testing/V1_1.php';
...
public function forgot_password_otp($parameters, $method, $user_id) {
    ...
    if (count($check_user) > 0) {
        ...
        $fogOtp ="Dear User,%nOTP to reset your password at UMDAA is $otp and is valid for 2 mins."; //working
    ...
    public function appointments($parameters, $method, $user_id)
    {
        ...
        if (count($patients) > 0) {
            ...
            foreach ($patients as $patient) {
                ...
                if ($patient->appointment_type == 'Follow-up') {
