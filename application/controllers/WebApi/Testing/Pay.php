        ...
        */
        ...
        public function naveen_get(){
            ...
            // <?php #Link to developer portal for connect to flow https://developer.exotel.com/api/#call-customer
                ...
                'Url' => "http://my.exotel.com/umdaa1/exoml/start_voice/339578", 
                'CallType' => "trans" );
                ...
                $url = "https://" . $api_key . ":" . $api_token . "@api.in.exotel.com /v1/Accounts/" . $exotel_sid . "/Calls/connect"; 
                ...
                $this->response(($http_result));
            }
            
            public function IVRS_get()
            {
            ...
            $response = Requests::post('https://<6ff35f3db1b7a138e764177e1e9a61ddbe72a648158df1e4>:<5c80b1322e205f4d8bf2dfc12ff932369678de300ab0c561><@api.in.exotel.com>/v1/Accounts/<umdaa1>/Calls/connect', $headers, $data);
         }
