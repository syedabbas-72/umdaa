   <div class="row page-header no-background no-shadow margin-b-0">
        ...
        <div class="col-lg-6 align-self-center text-right">
          <form method="post" action="<?php echo base_url('Consentform/Consentform_view/'.$consent_form_id);?>"  autocomplete="off" enctype="multipart/form-data">
    <input type="submit" name="getpdf" value="PDF">
   </form>
        </div>
    </div>
...
<div class="row">
   ...
   <tr>
	...
	<div style="padding-left:100pt;margin-top:20px;">
	<p><b>PATIENTS NAME:</b>&nbsp;--------------------------------------------------------------------------------- &nbsp;&nbsp;&nbsp;w/o, d/o, s/o &nbsp;--------------------------------------------------------------</p>
	<br/>
	<p><b>UMR NO:</b>&nbsp; --------------------------------------------------------------------------&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Age:</b>&nbsp; ------------------------------&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Sex:</b>&nbsp; -------------------------------</p>
	<br/>
	<p>I/we hereby declare and confirm that I/we have been given detailed oral explanation by:</p>
	<br/>
	<p><b>Dr.</b>&nbsp;----------------------------------------------------------------------------------------------------- in language I/we best understand</p>
	<br/>
	...
	<br/>
	<p>
	<b>INTENDED BENEFITS:</b><br/>
	<b><?php echo $Consentform_val->benefits;?></b>
	</p>
	<br/>
	<p><b>SERIOUS AND FREQUENTLY OCCURING RISKS,</b><br/>
	...
	<?php echo $Consentform_val->alternative;?></b>
	</p>
	<br/>
	...
	<br/><br/>
	_____________________________________________________________________________________________________________<br/><br/>_____________________________________________________________________________________________________________
	</p>
	<br/>
	<p>
