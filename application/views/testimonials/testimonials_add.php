       ...
       <div class="card-body">
          <div class="tabs">
              ...
              <div class="tab-content">
                  <div role="tabpanel" >
                  <form method="post" action="<?php echo base_url('Testimonials/testimonials_add');?>" autocomplete="off">
                          <div class="row col-md-12">
                              <div class="col-md-8"><div class="form-group">
                                <label for="title" class="col-form-label">Title</label>
                                  <input  name="title" type="text" placeholder="Title For Testimonial" class="form-control" >
                                </div>
                              </div>
                            </div>
                          <div class="row col-md-12">
                               <div class="col-md-4"><div class="form-group">
                                <label for="password" class="col-form-label">Testimonial Given By</label>
                                  <input  name="testimonial_given_by" type="text" placeholder="Testimonial Given By" class="form-control" >
                                </div>
                              </div>
