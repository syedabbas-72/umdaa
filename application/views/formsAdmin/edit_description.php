...
<div class="page-bar">
    ...
    <div class="page-title-breadcrumb col-lg-6">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="active">Umdaa Clinic/Forms/Edit</li>
        </ol>
    </div>
...
<a class="btn btn-primary" href="<?php echo base_url('FormsAdmin/add_details/'.$form_list_line_items->form_list_id);?>">
        Back 
        </a>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form  method="post" action="<?php echo base_url('FormsAdmin/edit_description_details/'.$form_list_line_items->id);?>">
            <div class="form-group">
                <label for="exampleInputEmail1">Name</label>
                <input type="text" class="form-control" name="name" id="type" required autocomplete="off" value="<?php echo $form_list_line_items->name?>" aria-describedby="emailHelp">

            </div>

            <div class="form-group">
                    <label for="benefits" class="col-form-label"> Description</label>
                    <textarea name="description" id="summernote" style="height: 400px"><?php echo $form_list_line_items->description?></textarea>
                </div>
