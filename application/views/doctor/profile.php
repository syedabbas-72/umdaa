        ...
        <div class="col-12">
            <div class="card">
              ...
              <div class="row col-md-12">                          
                ...
                <h4 class="page-title w-100">PROFILE INFORMATION
                <a href="<?=base_url('Doctor/Clinics/'.$doctor_info->doctor_id)?>" class="btn btn-app pull-right ml-2">Clinics</a>
                <div class="dropdown pull-right" style="margin-top:-1px !important">
                  <button class="btn btn-app dropdown-toggle" type="button" data-toggle="dropdown">Select Clinics To Schedule Timings
                  <i class="fa fa-caret"></i></button>
                  <ul class="dropdown-menu">
                    <?php 
                    foreach($clinicsInfo as $value){
                      ?>
                      <li><a href="<?=base_url('Doctor/Slots/'.$value->clinic_doctor_id)?>"><?=$value->clinic_name?></a></li>
                      <?php
                    }
                    ?>
                  </ul>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" name="department" required>
                                          ...
                                          foreach($departments as $value){
                                            ?>
                                            <option value="<?=$value->department_id?>" <?=($value->department_id == $doctor_info->department_id)?'selected':''?>><?=$value->department_name?></option>
                                            <?php
                                          }
                                          ?>
                                        </select>
                                            <!-- <input name="speciality" type="text" class="form-control" value="<?php echo $doctor_info->speciality; ?>"> -->
                                    </div>
                    ...
                    <textarea name="diseases_dealt" class="form-control" rows="3"  style="height: 100px"><?php echo $doctor_info->diseases_dealt; ?></textarea>
                                    ...
                                    <div class="form-group col-md-12" style="margin-left: 0px;">
                                      <label>Profile Image</label>
                                            <input type="file" id="image" name="profile_image" value="<?= $doctor_info->profile_image; ?>" class="form-control" accept="image/*"> 
                                            <!-- test -->
                                    ...
                                    if($doctor_info->profile_image != ""){
                                      ...
                                      <img src="<?=base_url('uploads/doctors/'.$doctor_info->profile_image)?>" class="mt-2" style="width:100px">
                                      <?php
                                    }
                                    ?>
                                    </div>
...
<!--                           
  ...
  <!-- </div> -->
  <h4 class="page-title w-100">DEGREES <a class="btn btn-app btn-xs pull-right"><i class="fa fa-plus" id = "add_row"></i></a></h4>
...
<h4 class="page-title w-100">ACHIEVEMENTS <a class="btn btn-app btn-xs pull-right"><i class="fa fa-plus" id="add_acheviement"></i></a></h4>
                          </div>
                                  <div class="row col-md-12">
<div class="form-group col-md-12">
...
<div class="row col-md-12">
  ...
  <h4 class="page-title w-100">MEMBERSHIP <a class="btn btn-app btn-xs pull-right"><i class="fa fa-plus" id="add_membership"></i></a></h4>
                          </div>
                                  <div class="row col-md-12">
<div class="form-group col-md-12">
