...
<body>
	<table cellpadding="0" cellspacing="0" style="width:800px; font-family: segoe ui;font-size:20px; color: #333" align="center">
		<!-- header -->
		<tr>
				...
				<table cellpadding="0" cellspacing="0" style="margin: 0px; padding: 0px; width: 100%;">
					<tr>
						<td style="width:25%">
							...
							?>
							<span style="color:#000; font-weight: 600; line-height: 25px;"><b><?php echo ucwords($patientName); ?></b></span><br>
							<b>UMR No.:</b>&nbsp;<?php echo $appointments->umr_no; ?><br>
							<?php 
							$moreInfo = '';
						...
						<td style="width:25%">
							<span style="color:#000; font-weight: 600; line-height: 25px;"><b><?php echo "Dr. ".strtoupper($appointments->dfname." ".$appointments->dlname); ?></b></span><br><span style="color:#000; font-weight: 600; line-height: 25px;"> &nbsp;<?php echo strtoupper($appointments->qualification. ", ". $appointments->department_name); ?> </span><br>
							<span style="color:#000; font-weight: 600; line-height: 25px;"><b>Reg. No:</b> &nbsp;<?php echo $appointments->registration_code; ?> </span>							
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td height="1200px" style="text-align: right; vertical-align: bottom">
