...
<body style="font-family: 'Poppins', sans-serif;">
	...
	<?php if(count($patient_clinical_diagnosis)>0){ ?>
		...
		<?php if(count($patient_prescription)>0) { ?>
			<div class="cls_007"><span class="cls_007" style="font-weight: bold; font-size:14px; line-height: 25px;text-transform: uppercase;">Prescription(Rx)</span></div>
			<table class="table" cellspacing="0" cellpadding="0" style="width: 100%; padding: 15px 10px">
				<thead>
					<tr>
		...
		<htmlpagefooter name="footer">
			<table cellpadding="0" cellspacing="0" style="margin: 0px; padding: 0px; width: 100%;">
				<tr>
					...
					<td style="width:35%;text-align: right;">
						<span style="font-weight: bold;font-size: 14px"><b>Date: </b><?php echo date("d/m/Y"); ?></span>
					</td>
				</tr>
			</table>
		</htmlpagefooter>
