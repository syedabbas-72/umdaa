...
<?php if($s_text != ''){?>
		...
		<table cellspacing="0" cellpadding="0" style="width: 100%; padding: 15px 10px">
				...
				<tr>
					<td style="padding: 10px">
						<span style="font-size:12px"><?php echo $c++ . ". " .ucwords($s_text);?></span>
					</td>
...
// $this->load->view("reports/default_pdf_header");
	...
	<?php
	$section_image = $this->db->query("select scribbling_image from patient_form_scribbling_images where patient_form_id='".$get_se_info[0]->patient_form_id."'")->result();
	foreach ($section_image as $sec_image) 
	{
		if($sec_image->scribbling_image == '' || $sec_image->scribbling_image == NULL)
		{
...
<?php 
$section_image = $this->db->query("select scribbling_image from patient_form_scribbling_images where patient_form_id='".$get_other_systems_info[0]->patient_form_id."'")->result();
