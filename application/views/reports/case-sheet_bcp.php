      ...
      <div class="card">
        <div class="row">
          <table class="table patient_info">
            <tr>
              <td width="33%" class="noBdr"><b>Patient:</b> <?php echo ucwords($patient_info->first_name." ".$patient_info->last_name); ?></td>
              <td width="33%" class="noBdr"><b>UMR NO:</b> <?php echo $patient_info->umr_no; ?></td>
              <td width="33%" class="noBdr"><b>Mobile:</b> <?php echo $patient_info->mobile; ?></td>
            </tr>
          </table>
        </div>
