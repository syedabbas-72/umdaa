    ...
    <div class="col-md-3 col-sm-12">
        ...
        <div class="card-box">
            <div class="card-head text-center">
                <header style="font-size:16px" onclick="blockCalendar()"><button class="btn btn-default"><i class="fas fa-calendar-alt"></i>BLOCK CALENDAR</button></header>
            </div>
            <div class="card-body ">
                    ...
                    <ul class="doctors-list">
                        ...
                        foreach ($doctors_list as $key => $values) {
                            ...
                            ?>_cnt" onclick="getdetails('<?php
                                ...
                                ?>')">
                                <span  class="doctor-category-list-item">
                                    <i class="fa fa-circle" style="color:<?php
                                    echo $get_doctor->color_code;
                                    ?>;font-size:13px;"></i>
                                    <span class="doctor-name">&nbsp;<?php
                                    echo "Dr. " . strtoupper($get_doctor->first_name . "  " . $get_doctor->last_name);
                                    ?></span><br>
                                    <span style="margin-left: 25px"><small><?php
                                    echo $get_doctor->department_name;
                                    ?></small></span> 
                                    <span class="num-appoint pull-right">
                                    </span>
                                </span>
                            </li>
                            <?php
    ...
    <div class="modal-dialog  modal-lg bookAppointmentModal" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                ?>
                <!-- <div class="row col-md-12 block_info" style="border:2px solid green"></div> -->
                ...
                */ ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control text-capitalize" id="npname" name="npname" value="" type="text" required >
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div id="WOM" style="display: none;" class="form-group">
                                ...
                                <input id="referred_by_person" name="referred_by_p" type="text" placeholder="Person Name" class="form-control" > 
                            </div>
                            <!-- ask for doctor name -->
                ...
                <div id="followUpDiv" style="display: none;margin-top: 20px">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="city-code">Mobile<span class="color-red">*</span></label>
                                <input class="form-control" maxlength="10"   onkeyup="checknull(this.value)" id="mobile" name="mobile" value="" type="text">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control text-capitalize" id="pname" name="pname" onkeyup="checknull(this.value)" value="" type="text">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="checkbox-primary margin-r-5" style="margin-top:35px">
                ...
                <div class="row" id="procedure_div" style="margin-top: 10px;display: none">
                    <div class="col-md-12">
                        <div class="form-group">
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header" style="text-align: center">
            <h5 class="modal-title">Block Calendar</h5>
         </div>
         <div class="modal-body">
            <?php
            ...
            <div class="row col-md-12">
               <div class="form-group no-margin-bottom col-md-6">
                  <label for="city-code">Doctor</label>
                  <select name="block_doctor" id="doctor_name" class="form-control">
                     <?php
                        foreach ($doctors_list as $key => $value) {
                            $doctor_info = $this->db->query("select * from doctors where doctor_id='" . $value->doctor_id . "'")->row();
                        ?>
