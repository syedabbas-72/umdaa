...
<div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                        <form  method="post" action="<?php echo base_url('Wallet/demo1234/'.$price_edit->wallet_specialization_prices_id);?>">
  <div class="form-group">
    <label for="exampleInputEmail1">Speciality</label>
    <input type="text" required value="<?=$price_edit->speciality?>"  class="form-control" name="type" id="type" aria-describedby="emailHelp">
