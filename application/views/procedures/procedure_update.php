...
<html lang="en">
    ...
    <body>
      ...
      <form method="POST" action="<?php echo base_url('procedure_update/update');?>" >
<div class="row">
         <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <textarea name="description" id="summernote"><?php echo $procedure_description; ?></textarea>

                        </div>
                        <input type="hidden" value="<?php echo $medical_procedure_id;?>" name="medical_procedure_id">
                        <input type="hidden" value="<?php echo $doctor_id ;?>" name="doctor_id">
                        <input type="hidden" value="<?php echo $user_id;?>" name="user_id">
                        <input type="hidden" value="<?php echo $clinic_id ;?>" name="clinic_id">
                    </div>
                     <div class="col-md-12" style="text-align: center">
                            <input class="btn btn-success"  type="submit" name="submit" value="Change Procedure">
                        </div>
                </div>
      </div>
  </form>
