                    ...
                    <div class="col-md-9" id="view_caseresults" class="view_caseresults">
                        ...
                        <div class="row col-md-12" style="padding-right: 0px">
                            <table id="doctorlist" class="table dt-responsive nowrap customTable">
                                ...
                                <tbody>  
                                    <?php $i=1; foreach ($appointments as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center noBdrRight"><a target="_blank" href="<?php echo base_url("summaryReports/print_summary/".$value->appointment_id); ?>"><i class="fa fa-print"></i></a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
