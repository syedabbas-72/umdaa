    ...
    function createParameter(template){
        ...
        if(template == 'General'){
            ...
            $.ajax({
                url : base_url+"/Lab/createParameter",
                method : "POST",
                data : {"parent_clinic_investigation_id":$("#parent_clinic_investigation_id_tb").val(), "parent_investigation_id":$("#parent_investigation_id_tb").val(), "investigation":$("#general_parameter_tb").val(), "remarks":$("#remark_ta").val()},
                success : function(result) {
                    console.log(result);
                    return false;
                    // location.reload();
