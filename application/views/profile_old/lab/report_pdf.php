                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            ...
                                            <br>
                                            <span style="font-weight: bold; font-size: 13px; color:#000; text-transform: uppercase;"><?=$report_info->consultant_fname." ".$report_info->consultant_lname?></span><br>
                                            <span style="font-weight: bold; font-size: 13px; color: #000">CONSULTANT</span>
                                        </center>
                                    </td>
                                </tr>
                        </tbody>
                                        ...
                                        <table>
                                            <tr>
                                                <td style="text-align: center">
                                                    ...
                                                    <span style="font-weight: bold; font-size: 14px; text-transform: uppercase;"><?=$report_info->consultant_fname." ".$report_info->consultant_lname?></span><br>
