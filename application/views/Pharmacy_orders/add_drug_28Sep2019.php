				...
				<?php //echo "<pre>";print_r($salt_info); ?>
					...
					<div class="inventoryDiv" id="inventoryDiv">	
						<div class="row col-md-12">
							...
							<div class="row">
								<div class="col-md-6">
									<select name="drug[0][expiryMonth]" class="form-control" required="">
								...
								<div class="col-md-6">
									<select name="drug[0][expiryYear]" class="form-control" required="">
					        ...
					        <div class="form-group col-md-2">
								<!-- Plus button -->
								<i class="fas fa-plus-circle plus" onclick="return addBatch();" style="margin-top: 10px;"></i>
					        </div>
						</div>	
					</div>
