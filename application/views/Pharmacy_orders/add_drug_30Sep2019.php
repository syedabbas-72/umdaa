		...
		if(saltName == ''){
			...
			$.ajax({
				...
				success : function(rdata) { 
					...
					html = '';
					html = '<div class="row" id="'+counter+'_row" style="border:1px solid red;">';
					...
					html += '<div class="col col-md-1"><div class="form-group"><input type="text" class="form-control" id="schedule_'+counter+'_tb" name="salt['+counter+'][schedule]" placeholder="Sch" value="'+a[1]+'"></div></div>';
					html += '<div class="col-md-1 padding-0"><div class="form-group"><i class="fas fa-minus-circle minus" onclick="return removeDiv(\''+counter+'_row\');"></i></div></div>';
					html += '</div>';
					counter++;
					...
					<div class="inventoryDiv" id="inventoryDiv">
						...
						<div class="row">
							<div class="form-group col-md-2">
								<input type ="text" class="form-control" id = "batch_tb" name="drug[0][batch_no]" value="0">
							</div>
							<div class="form-group col-md-2">
								<input type ="text" class="form-control" id = "pack_size_tb" name="drug[0][pack_size]" value="0">
					        </div>
					        <div class="form-group col-md-2">
								<input type ="text" class="form-control" id = "quantity_tb" name="drug[0][quantity]" value="0">
					        </div>
					        <div class="form-group col-md-2">
								<input type ="text" class="form-control" id = "mrp_tb" name="drug[0][mrp]" value="0">
					        </div>
							<div class="form-group col-md-2">
								<input type ="text" class="form-control solo" name="drug[0][expirydate]" value="" maxlength="10" placeholder="DD / MM / YYYY">
					        </div>
					        <!-- <div class="form-group col-md-2">
