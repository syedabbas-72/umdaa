                                            ...
                                            <table cellspacing="0" cellpadding="0" class="table finances">
                                                <tr>
                                                    <td class="noBdr btmBdr">
                                                        ...
                                                        EXPECTED REVENUE (from <?php echo $prescriptions_count; ?> prescription(s))
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="noBdr">
                                                        <span class="amt convertedRevenue">
                                                          ...
                                                          <?php 
                                                            ...
                                                            ?></span><br />
                                                        CONVERTED REVENUE (From <?php echo $billing_count;?> Prescription(s))
                                                    </td>
                                                </tr>
                                                 <tr>
                                                    <td class="noBdr">
                                                        <span class="amt outPeople">
                                                          ...
                                                          <?php 
                                                            ...
                                                            ?></span><br />
                                                       OUT PEOPLE (Outside <?php echo $out_people_count; ?> people)
                                                    </td>
                                                </tr>
                                                 <tr>
                                                    <td class="noBdr">
