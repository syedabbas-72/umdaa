			...
			<div class="tabs">
                ...
                <div class="tab-content">
								...
								<table id="doctorlist" class="table dataTable table-bordered dt-responsive customTable">
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center actions"><a href="<?=base_url("Pharmacy_orders/edit_order/".$value['drug_id']."/".$value['batch_no'])?>" ><i class="fas fa-pencil-alt editSmall" style="font-size: 17px;color: #333333bf;" title="Edit"></i></a>
                        ...
                        <div class="col-md-12">
							<form method="post" action="<?php echo base_url('Pharmacy_orders/raise_shortage_indent'); ?>">
								...
								<table class="table dataTable table-bordered dt-responsive nowrap">
									...
									<td>
										<select class="form-control input-small" required="" name="vendor[]">
											<option selected="" disabled="">Select Vendor</option>
										<?php
										foreach ($vendor_list as $value) {
											?>
											<option value="<?=$value->vendor_id?>"><?=$value->vendor_storeName.", ".$value->vendor_location?></option>
											<?php
										}
										?>
										</select>
					...
					<div role="tabpanel" class="tab-pane" id="notif">                                      
					  	<div class="col-md-12">
							<table id="doctorlist" class="table dataTable table-bordered dt-responsive nowrap">
								<thead class="thdClr">
									<tr>
										<th>S.No</th>
										<th>Drug Name</th>
