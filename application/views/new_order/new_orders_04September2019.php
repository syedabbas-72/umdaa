							...
							<div class="row">
								<div class="col-md-3">
		                            <div class="form-group">
		                                ...
		                                <input type="text" id="" maxlength="35" onkeypress="return alpha()" name="pname" style="text-transform: capitalize;" class="form-control" placeholder="Name" required>
		                            </div>
		                        </div>
		                        <div class="col-md-3">
		                            <div class="form-group">
		                                <label for="pmobile" class="col-form-label">Mobile No.</label>
		                                <input type="text" class="form-control" style="text-transform: capitalize;" id="pmobile" name="pmobile" placeholder="Mobile" required maxlength="10" minlength="10" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
		                            </div>
		                        </div>
		                        <div class="col-md-6">
		                        	<div class="form-group">
                            		...
                            		<table id="orderlist" class="table dt-responsive nowrap customTable">
										<thead>
											<tr>
												...
												<th style="width: 25%" class="text-center">Batch - Quantity</th>
												<th style="width: 10%" class="text-right">Amount</th>
												<th style="width: 10%" class="text-center">Discount (%)</th>
												<th style="width: 10%" class="text-right">Pay Amount</th>	
											...
											if(count($pdrugs)>0){
												...
												foreach($pdrugs as $presult){ 
													...
													<tr id="orderlist_<?php echo $presult['drug_id']; ?>_tr">
														...
														<td>
															<?php echo $presult['trade_name']."<br>".$presult['salt']; ?><br />
														...
														<td><span id="actual_amt_span_<?php echo $presult['drug_id']; ?>" class="mrp">ghsfd</span></td>
														<td>
															<input type="number" class="disc" name="disc[]" id="disc_<?php echo $presult['drug_id']; ?>" value="0">
														</td>
														<td>
															<span id="amt_span_<?php echo $presult['drug_id']; ?>" class="mrp" style="display:none"></span>
															<input type="text" name="toqty[]" id="tqty_<?php echo $presult['drug_id']; ?>" />
															<input type="text" name="toamt[]" id="toamt_<?php echo $presult['drug_id']; ?>" />
															<input type="text" name="totrw[]" id="totrw<?php echo $presult['drug_id']; ?>" class="totrw" value="<?php echo $presult['drug_id']; ?>" />
															<input type="text" id="disc_tb_<?php echo $presult['drug_id']; ?>" value="<?php echo $presult['discount']; ?>" />
															<input type="text" name="amt[]" id="amt_<?php echo $presult['drug_id']; ?>" value="" class="testp" />
															<input type="text" name="drgid[]" id="drgid_<?php echo $presult['drug_id']; ?>" value="<?php echo $presult['drug_id']; ?>" />
															<input type="text" name="pdid" value="<?php echo $pdid; ?>" />
														</td>
													</tr>
													<?php 
													$i++;
