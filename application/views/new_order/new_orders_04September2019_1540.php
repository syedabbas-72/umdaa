												...
												foreach($pdrugs as $presult){ 
													...
													<tr id="orderlist_<?php echo $presult['drug_id']; ?>_tr">
														...
														<?php if($stock == 0) {
															?>
															<td>
																<input type="text" name="qty[]" id="qty_<?php echo $presult['drug_id']; ?>" class="form-control noStock" readonly placeholder="No Stock Available" style="color:#000">
															</td>
															<?php 
														}else{
															?>
															<td>
																<a onclick="get_batch_details('<?php echo $presult['drug_id']; ?>');" data-toggle="modal"  data-target="#myModal"><input type="text" name="qty[]" id="qty_<?php echo $presult['drug_id']; ?>" class="form-control stock" readonly placeholder="Click and Place Required Quantity" style="color:#000"> </a>
															</td>
															<?php 
														} ?>
														
														<td><span id="actual_amt_span_<?php echo $presult['drug_id']; ?>" class="mrp text-right"></span></td>
														<td>
														...
														<td class="text-right">
															...
															<input type="hidden" name="toqty[]" id="tqty_<?php echo $presult['drug_id']; ?>" />
														...
														<td class="text-center" style="vertical-align: center"><i class="fa fa-minus-circle delete remove_drug_p" id="orderlist_<?php echo $presult['drug_id']; ?>_tr"><i></td>
													</tr>
													<?php 
													$i++;
												}
