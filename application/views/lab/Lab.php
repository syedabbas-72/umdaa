...
//    echo "</pre>";
	...
	*/
	...
	public function investigations()
	{
		...
		foreach($investigations as $inv){
			...
			->from('clinic_investigation_price')->where('clinic_investigation_id =',$inv['clinic_investigation_id'])
	...
	*/
	...
	public function pay_osa($billing_id){
		...
		$data['invoices'] = $this->db->select('BI.invoice_no, BI.billing_id, BI.invoice_no_alias,
	...
	public function get_template_info()
	{
		...
		*/
		...
		if($lab_template_info->template_type == 'Excel'){
			...
			$tinfo = '';
			$tinfo .= '<tr><th colspan="3">'.$lab_template_info->template_name.'<input type="hidden" id="position_update_tb" name="position_update" value=0><input type="hidden" id="clinic_lab_template_id_tb" name="clinic_lab_template_id" value="'.$clinic_lab_template_id.'"><span class="customBtn pull-right mt-0" name="template_excel"></span></th></tr>';
	...
	public function templates_input_save()
	{
		...
		// ->where('R.patient_lab_report_id =',$templateLineItems->patient_lab_report_id)
		->get()->result();

		// echo '<pre>';
		// print_r($templateLineItemsss);
		// echo '</pre>';
		// exit();
		...
		if($type == 'general')
		{
			...
			$result = $this->Generic_model->updateData('patient_lab_reports',$consultant_remark,array('patient_lab_report_id' => $patient_lab_report_id));
		}
		else{
