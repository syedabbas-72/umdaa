													...
													<tr class="redRows">
														...
														<td class="text-center actions">
															...
															<?php if ($crudInfo->p_delete) { ?>
																<a onclick="return doconfirm()" href="<?= base_url("Lab/delete_lab_investigation/".$value['clinic_lab_template_id']."/".$value['investigation_id']) ?>"><i class="fas fa-trash-alt deleteSmall" title="Edit"></i></a>
															<?php } ?>
														</td>
													</tr>
													<?php
		...
		$.ajax({
			...
			success: function(result) {
				...
				if (template_type == 'Excel') {
					html += '<th colspan="3" class="title">' + investigationsInfo['package'].template_name + '<input type="hidden" name="investigation_id" value="' + investigationsInfo['package'].investigation_id + '"><input type="hidden" name="clinic_investigation_price_id" value="' + clinic_investigation_price_id + '"><input type="hidden" name="template_type" value="' + template_type + '"></th>';
					...
					colspan = 2;
					html += '<th colspan="2" class="title">' + investigationsInfo['package'].template_name + '<input type="hidden" name="investigation_id" value="' + investigationsInfo['package'].investigation_id + '"><input type="hidden" name="clinic_investigation_price_id" value="' + clinic_investigation_price_id + '"><input type="hidden" name="template_type" value="' + template_type + '"></th>';
