										...
										<tr>
											<td style="vertical-align: top; border-top:none;">
												...
												<?php if($billingInfo->doctor_id != 0){ ?>
													<span><?=strtoupper($doctorInfo->first_name." ".$doctorInfo->$last_name)?></span><br>
									...
									<table class="table dt-responsive customTable">
										...
										<tbody>
											...
											<tr>
												...
												<a href="<?php echo base_url('Lab/LabInvoice/'.$value['billing_invoice_id']);?>" target="_blank"><i class="fas fa-print print"></i></a>
