    ...
    <div class="card-header" style="font-size: 15px;padding: 10px 20px">PROFILE INFORMATION</div>
              ...
              <div class="form-group col-md-6">
                                        <label>First Name</label>
                                            <input  style="text-transform: capitalize;"  name="first_name" type="text" class="form-control" value="<?php echo $doctor_info->first_name; ?>">
                                    </div>
                                 

                                    <div class="form-group col-md-6">
                                        <label>Last Name</label>
                                            <input  style="text-transform: capitalize;" name="last_name" type="text" class="form-control" value="<?php echo $doctor_info->last_name; ?>">
                                    </div>
...
<td align="center"><b>Year</b></td>
 ...
 ?>
<tr>
<td><input style="text-transform: capitalize;"  type="text" name="Degree[0][degree]" value = "<?php echo $qualification[$i];?>"></td>
<td><input style="text-transform: capitalize;"  type="text" name="Degree[0][college]" value = "<?php echo $doctor_info->university;?>"></td>
<td><input type="text" name="Degree[0][year]" value = "<?php echo $doctor_info->year_of_passing;?>"></td>
</tr>
<?php } } else { ?>

  <tr>
<td><input style="text-transform: capitalize;"  type="text" name="Degree[0][degree]"></td>
<td><input style="text-transform: capitalize;"  type="text" name="Degree[0][college]"></td>
<td><input style="text-transform: capitalize;"  type="text" name="Degree[0][year]"></td>
</tr>
...
<tbody id = "add_acheviement_row">
  ...
  if(count($doctor_info->acheivements)>0) { 
   ...
   ?>
<tr>
<td><input style="text-transform: capitalize;"  type="text" name="achievements[]" value = "<?php echo $acheivements[$j];?>"></td>
<td></td>
</tr>
<?php } } else { ?>
<tr>
