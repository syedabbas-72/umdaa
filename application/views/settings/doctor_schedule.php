                ...
                <div class="row ">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="walkin" role="tabpanel" aria-labelledby="walkin-tab">
                            ...
                            <form action="<?=base_url('Settings/addSlots')?>" method="post">
                                        ...
                                        <div class="row py-3 border-bottom">
                                            ...
                                            <div class="col-10 p-0">
                                                <div class="row">
                                                    ...
                                                    <input type="time" class="form-control w-50" name="mr_start[]" value="<?=$mrSlots->from_time?>" id="<?=$daynames[$i]?>_mr_walkin_from">
                                                    <input type="time" class="form-control w-50" name="mr_end[]" value="<?=$mrSlots->to_time?>" id="<?=$daynames[$i]?>_mr_walkin_to">
                                                ...
                                                <div class="col-4 d-inline-flex">
                                                    <input type="time" class="form-control w-50" name="af_start[]" value="<?=$afSlots->from_time?>" id="<?=$daynames[$i]?>_af_walkin_from">
                                                    <input type="time" class="form-control w-50" name="af_end[]" value="<?=$afSlots->to_time?>" id="<?=$daynames[$i]?>_af_walkin_to">
                                                ...
                                                <div class="col-4 d-inline-flex">
                                                    <input type="time" class="form-control w-50" name="ev_start[]" value="<?=$evSlots->from_time?>" id="<?=$daynames[$i]?>_ev_walkin_from">
                                                    <input type="time" class="form-control w-50" name="ev_end[]" value="<?=$evSlots->to_time?>" id="<?=$daynames[$i]?>_ev_walkin_to">
                                    ...
                                    for($i=1;$i<=7;$i++)
                                    {
                                        ...
                                        <div class="row py-3 border-bottom">
                                            ...
                                            <div class="col-10 p-0">
                                                <div class="row">
                                                    <div class="col-4 d-inline-flex">
                                                    <input type="time" class="form-control w-50" name="mr_start[]" value="<?=$mrSlots->from_time?>" id="<?=$daynames[$i]?>_mr_tele_from">
                                                    <input type="time" class="form-control w-50" name="mr_end[]" value="<?=$mrSlots->to_time?>" id="<?=$daynames[$i]?>_mr_tele_to">
                                                ...
                                                <div class="col-4 d-inline-flex">
                                                    <input type="time" class="form-control w-50" name="af_start[]" value="<?=$afSlots->from_time?>" id="<?=$daynames[$i]?>_af_tele_from">
                                                    <input type="time" class="form-control w-50" name="af_end[]" value="<?=$afSlots->to_time?>" id="<?=$daynames[$i]?>_af_tele_to">
                                                ...
                                                <div class="col-4 d-inline-flex">
                                                    <input type="time" class="form-control w-50" name="ev_start[]" value="<?=$evSlots->from_time?>" id="<?=$daynames[$i]?>_ev_tele_from">
                                                    <input type="time" class="form-control w-50" name="ev_end[]" value="<?=$evSlots->to_time?>" id="<?=$daynames[$i]?>_ev_tele_to">
