   ...
   <section class="main-content">
    <div class="row">
           ...
           <div class="card-header card-default">
                        ...
                        <div class="card-body">
    <form method="post" id="roleEdit_form" action="<?php echo base_url('Admin/save_entity_settings');?>" enctype="multipart/form-data">
    	<div class="row">
    		<div class="col-sm-12">

                  <div class='col-md-3 form-group'>
                   
                                            <select name="category_name" class="form-control m-b" onchange="get_entities()">
...
var url = "<?php echo base_url('admin/get_entities'); ?>";
$.ajax({
            type: 'POST',
            url: url,
            data: {},
