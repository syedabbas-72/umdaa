<div class="page-bar">
    <div class="page-title-breadcrumb">
        <ol class="breadcrumb page-breadcrumb pull-left">
            ...
            <li>Lab Staff&nbsp;<i class="fa fa-angle-right"></i></li>
            <li class="active">Add Employee </li>
        </ol>

        <div class="pull-right tPadding">
            <a href="<?= base_url('lab/settings'); ?>" class="btn btn-primary btn-icon"><i class="fas fa-backward"></i> Back</a>
        </div>
    </div>
</div>
                ...
                <div class="card-body">
                    <div class="tabs">
                        <div class="tab-content">
                            <div role="tabpanel" >       
                                <form method="POST" action="<?php echo base_url('lab/lab_employee_add');?>" role="form">
                                    <div class="row">
                                        <div class="col-md-3">
