                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                          ...
                          <form method="POST" action="<?php echo base_url('Salt/edit'.$salt->salt_id);?>" role="form">
                            <div class = "row">
                              <div class = "col-md-6">
                                <div class = "form-group">
                                  <label for="name">Salt Name</label>
                                  <input type="text" class = "form-control" name = "name" value="<?php echo $salt->salt_name;?>" required=""  />
                                </div>
                              </div>
                              <div class = "col-md-6">
                                <div class = "form-group">
                                  ...
                                  <select name="status" class = "form-control" required="">
                                    <?php if($salt->status == 1) { ?>
                                    <option value = "<?php echo $salt->status;?>">Active</option>
                                    <option value="0">Inactive</option>
                                  <?php }else{ ?>
                                    <option value = "<?php echo $salt->status;?>">Inactive</option>
