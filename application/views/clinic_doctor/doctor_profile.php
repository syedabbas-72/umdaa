                            ...
                            <div id="biography" >
                                                <div class="row">
                                                    <div class="col-md-3 col-6 b-r"> <strong>Full Name</strong>
                                                        <br>
                                                        <p class="text-muted"><?php echo "Dr. ".$doctor_info->first_name." ".$doctor_info->last_name; ?></p>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3 col-6 b-r"> <strong>Email</strong>
                                                        <br>
                                                        <p class="text-muted"><?php echo $doctor_info->email;?></p>
                                                    </div>
                                                ...
                                                <ul>
                                                    ...
                                                    foreach ($education_info as $key => $value) { ?>
                                                        <li><?php echo $value->degree_name.",".$value->university.", ".$value->year; ?></li>
