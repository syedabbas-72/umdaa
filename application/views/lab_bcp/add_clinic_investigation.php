...
<div class="page-bar">
  <div class="page-title-breadcrumb">
      ...
      <ol class="breadcrumb page-breadcrumb pull-right">
          ...
          <li><a class="parent-item" href="<?php echo base_url('lab/lab_investigations'); ?>">INVESTIGATIONS</a>&nbsp;<i class="fa fa-angle-right"></i>
          </li>         
            ...
            <div class="row">             
                <div class="col-md-12">
                    <div class="card">
						...
						<span style="color: red;font-weight: bold">Investigation add to master<span>
						</div>
                         <div class="row">
                         	<div class="col-md-11">
