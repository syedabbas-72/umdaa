	    ...
	    <div class="col-md-12">
			...
			<form method="post" action="<?php echo base_url('Lab/save_lab_order'); ?>">
				<div class="row">
					...
					<div class="col-md-6">
					    	<div id="patient_info">
					    		<table width="600"  cell-spacing="0"><tbody><tr><td><input  class="form-control" type="text" name="pname" style="text-transform: capitalize;" placeholder="Name" required></td><td></td><td><input class="form-control"  type="text" style="text-transform: capitalize;" name="pmobile" placeholder="Mobile" required></td></tr></tbody></table>
					       </div>
						</div>
				    </div>
				    <br>
				<div class="row">
					...
					<div class="col-md-11">
						<input type="text" class="form-control"  name="search_investigation" placeholder="search by investigation name" id="search_investigation" onclick="clinicinvestigationsearch();" /><!-- &nbsp;&nbsp;&nbsp;<span class="pluse">  <i class="fa fa-plus-circle" aria-hidden="true" onclick="add_row('orderlist');"></i></span> -->
				    </div>
				...
				<table id="orderlist1" class="table table-bordered dt-responsive nowrap" >
					...
					<input class="form-group" type="checkbox" value="1" onclick="ienable_discount('<?php echo $cl_discount; ?>');" id="iapdis" name="iapdis" />&nbsp;Apply Discount
						...
						<tr>
							...
							<input type="text" class="form-control"  id="ptm_txt" name="ptm_txt" style="display:none" />
							</td>
							<td colspan="3" class="form-control"  style="width: 250px">Total
							</td>
