    ...
    <body class="bg-light">
        ...
        <div class="misc-wrapper">
            <div class="misc-content">
                ...
                <?php endif; ?>
                            <div class="misc-box">   
                                <?php echo form_open(base_url('auth/forgot_password'), 'class="login100-form validate-form" autocomplete="off"'); ?>
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="float-right">
                                            ...
                                            <input class="btn btn-block btn-primary btn-rounded box-shadow" type="submit" name="submit" id="submit" value="Submit">
                                        </div>
                                    </div>
