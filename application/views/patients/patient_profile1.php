...
<div class="row">
    ...
    <div class="col-md-12">
    <div class="form-group ulgroup"><ul><li class="ligroup" id="Profile" onclick="getPatientInfo('Profile',1,357,20)">Profile</li><li class="ligroup" id="Appointments" onclick="getPatientInfo('Appointments',1,357,20)">Appointments</li>
     </ul></div></div></div>
                <div class="col-md-9 row" id="view_caseresults" class="view_caseresults">
...
getPatientInfo('Profile',<?php echo $clinic_id;?>,<?php echo $patient_id;?>);
...
beforeSend:function(data){ 
 ...
 $('#clinic_patients').html('<img height="50px" width="50px" src="<?php echo base_url('assets/images/load.gif');?>" />');
...
var url = "<?php echo  base_url('patients/getPatientInfo'); ?>";
$.ajax({
  type : 'POST',
  url : url,
  data: {
  ...
  beforeSend:function(data){ 
   ...
   $('#view_caseresults').html('<img height="50px" width="50px" src="<?php echo base_url('assets/images/load.gif');?>" />');
  },success:function (data) {
