                                    ...
                                    <div class="row">                          
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="title" class="col-form-label">Title <span class="imp">*</span></label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="first_name" value='<?php echo ucfirst($patients_list->first_name); ?>' style="text-transform: capitalize;" name="first_name" type="text" class="form-control" required  onkeypress="return alpha()" maxlength="35">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="last_name" class="col-form-label">Last Name</label>
                                                <input id="last_name" value='<?php echo ucfirst($patients_list->last_name); ?>' style="text-transform: capitalize;" name="last_name" type="text" class="form-control"  onkeypress="return alpha()" maxlength="35">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="gender" class="col-form-label">Gender <span class="imp">*</span></label>
                                                <select id="gender" name="gender" placeholder="" class="form-control" required="" onchange="genderStatus(this.value)">
                                                    <option value="">-- Select --</option>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="age" class="col-form-label">Age <span class="imp">*</span></label>
                                                <div class="form-inline">
                                                    <input id="age" name="age" type="text" placeholder="" class="form-control" value="<?php echo $patients_list->age?>" required onkeypress="return numeric()" style="width: 39px;padding-left:5px !important;padding-right: 5px !important;" maxlength="3">
                                                    <select class="form-control" name="age_unit" required="">
                                                        ...
                                                        <option value="Years" <?=($patients_list->age_unit=="Years")?'selected':'selected'?> >Years</option>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="occupation" style="text-transform: capitalize;" name="occupation" type="text" placeholder="Occupation" class="form-control" onkeypress="return alpha()" value="<?php echo ucfirst($patients_list->occupation); ?>" maxlength="35">                                        
                                            </div>
                                        </div>                                          
                                    </div>
                                    ...
                                    <div class="row">         
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="email_id" name="email_id" type="email" placeholder="" class="form-control" value="<?php echo DataCrypt( $patients_list->email_id, 'decrypt')?>" maxlength="50">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input id="address" style="text-transform: capitalize;" name="address" type="text" placeholder="" class="form-control" value='<?php echo $patients_list->address_line?>' maxlength="255">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="address" class="col-form-label">Area<span class="imp">*</span></label>
                                                <input id="location"  style="text-transform: capitalize;" name="location" type="text" placeholder="" class="form-control"  value='<?php echo $patients_list->location?>' required maxlength="35">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="state_id" class="col-form-label">State <span class="imp">*</span></label>
                                                <select id="state_id" name="state_id" required="" placeholder="" class="form-control" onchange="getDistricts(this.value)" >
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="district_id" class="col-form-label">District <span class="imp">*</span></label>
                                                <select id="get_district_id" name="district_id" required="" placeholder="" class="form-control">
                                                    <option value='0'>-- Select --</option>
                                                </select>    
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="pincode" class="col-form-label">Pincode <span class="imp">*</span></label>
                                                <input id="pincode" name="pincode" type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57" placeholder="" required class="form-control" value="<?php echo $patients_list->pincode;?>"  maxlength="6" minlength="6" maxlength="6">
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    var backYear = parseInt(CurrentYear)-150;
    $('.dob').datepicker({
        maxDate : new Date(),
        changeYear : true,
        changeMonth : true,        
        shortYearCutoff: 50,
        yearRange: backYear+":"+CurrentYear,
        dateFormat : 'dd/mm/yy'
    });
</script>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#dob').on("change",function(){
            ...
            $('#age').val(age);
            var select_val = "option[val='Years']";
            $("input[name=age_unit]").find(select_val).attr("selected", "selected");
        });
