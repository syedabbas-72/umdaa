       ...
       <div class="card-body">
          <div class="tabs">
              ...
              <div class="tab-content">
                  <div role="tabpanel" >
                  <form method="post" action="<?php echo base_url('Users/users_add');?>" autocomplete="off">
                            ...
                            <div class="col-md-4"><div class="form-group">
                              <label for="role_id" class="col-form-label">ROLE</label>
                                 <select id="role_id" name="role_id" type="text" placeholder="" class="form-control">
                                        ...
                                        <?php foreach ($roles as $value1) {?>
                                        <option value="<?php echo $value1->role_id;?>"><?php echo $value1->role_name;?></option>
                                      <?php } ?>
                                    </select>
                              </div>
                            </div>
