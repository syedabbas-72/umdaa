                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <table cellspacing="0" cellpadding="0" class="table finances">
                                        <?php foreach($patients as $presult){ ?>
                                        <tr>
                                            <td class="noBdr btmBdr">                                               
                                                <?php echo $presult['pname']; ?> (<?php echo $presult['gender'].",".$presult['age']; ?>) <br />
                                                <?php echo $presult['doctor']; ?> <?php if($presult['dc_status']!=0){ ?>
                                                <a href="<?php echo base_url('New_order/add_order/'.$presult['pdid']); ?>" target="_blank"><input type="button" value="Convert" /></a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                                    ...
                                                    <td class="noBdr btmBdr">
                                                        <span class="amt expectedRevenue">
                                                          <i class='fas fa-rupee-sign'></i> 
                                                            <?php 
                                                            if($erevenue){
                                                                echo round($erevenue,2);
                                                            }else{
                                                                echo 0.00;
                                                            } 
                                                            ?>
                                                        </span><br />
                                                        EXPECTED REVENUE (from prescriptions)
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="noBdr">
                                                        <span class="amt convertedRevenue">
                                                          ...
                                                          <?php 
                                                            if($crevenue){
                                                                echo round($crevenue,2);
                                                            }else{
                                                                echo 0.00;
                                                            } 
                                                            ?></span><br />
                                                        CONVERTED REVENUE (From Prescriptions)
                                                    </td>
                                                </tr>
                                                 <tr>
                                                    <td class="noBdr">
                                                        <span class="amt outPeople">
                                                          ...
                                                          <?php 
                                                            if($drug->oamt){
                                                                echo round($drug->oamt,2);
                                                            }else{
                                                                echo 0.00;
                                                            } 
                                                            ?></span><br />
                                                       OUT PEOPLE (Outside people)
                                                    </td>
                                                </tr>
                                                 <tr>
                                                    <td class="noBdr">
                                                        <span class="amt lostAmount">
                                                          <i class='fas fa-rupee-sign'></i> 
                                                          <?php 
                                                            if($erevenue){
                                                                echo round($erevenue-$crevenue,2);
                                                            }else{
                                                                echo 0.00;
                                                            } 
                                                            ?></span><br />
                                                       LOST AMOUNT (Unconverted prescriptions)
...
<div class="col-md-12 sidebar-container">
  ...
  <div class="doctors-list-container">
            <div class="calendar-sidebar-subhead">PHARMACY DASHBOARD</div>
            <div class="doctors-list-column doctor-side">
                <div class="newcalendar-sidebar">
       <input type="hidden" value="all" id="dispval" />           
					...
					<tr>
					<td>PRESCRIPTIONS</td><td>FINANCES</td>
					</tr>
					<tr>
					<td></td><td><?php echo $drug->camt; ?></td>
					</tr>
    ...
    $(function() {
        ...
        function cb(start, end) {
            ...
            function(data){
                ...
                $('.lostAmount').html("<i class='fas fa-rupee-sign'></i> "+data[3]);
            });
        }
