									...
									<table id="doctorlist" class="table table-bordered dt-responsive">
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo str_replace(",", ", ", $value['ctests']); ?></td>
												<td><?php echo $value['inv_amt']; ?></td>
												<td><?php echo $value['out_amt']; ?></td>
												<td><?php echo $value['osa_amt']; ?></td>
												<td><?php if($value['osa_amt'] <= 0){ echo "<span style='color:green;font-weight:bold'>Completed</span>"; } else { echo "<span style='color:red;font-weight:bold'>Pending</span>"; } ?>
												</td>
