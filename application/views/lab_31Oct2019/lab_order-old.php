	    ...
	    <div class="col-md-12">
			...
			<form method="post" action="<?php echo base_url('Lab/save_lab_order'); ?>">
				...
				<div class="row">
					...
					<div class="col-md-11">
						<input  class="form-control" type="text" name="search_investigation" placeholder="Search by investigation name" id="search_investigation" onclick="clinicinvestigationsearch();" /><!-- &nbsp;&nbsp;&nbsp;<span class="pluse">  <i class="fa fa-plus-circle" aria-hidden="true" onclick="add_row('orderlist');"></i></span> -->
				    </div>
