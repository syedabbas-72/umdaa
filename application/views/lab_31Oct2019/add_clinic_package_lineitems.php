<div class="row page-header">
   <div class="col-lg-6 align-self-center">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?= base_url('Lab/lab_packages'); ?>">LAB PACKAGES</a></li>
          <li class="breadcrumb-item active"><a href="#">ADD ITEM</a></li>
        </ol>
  </div>
</div>
                ...
                <div class="col-md-12">
                    <div class="card">
						...
						<span style="color: red;font-weight: bold">Investigation Is not Available Please add to Clinic Master<span> <a href="<?= base_url('Lab/add_clinic_investigation'); ?>" class="btn btn-primary btn-rounded btn-xs box-shadow"> ADD NEW INVESTIGATION</a>
                         ...
                         <div class="row">
                         	<div class="col-md-11">
						<input type="text" name="search_investigation" placeholder="search by investigation name" id="search_investigation" onclick="clinicinvestigationsearch();" />&nbsp;&nbsp;&nbsp;<span class="pluse"></span>
					</div>
