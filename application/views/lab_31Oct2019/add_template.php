<div class="row page-header">
   <div class="col-lg-6 align-self-center">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="#">ADD NEW TEMPLATE</a></li>
        </ol>
  </div>
</div>
        ...
        <section class="main-content">
            <div class="row">             
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                          <form method="POST" action="<?php echo base_url('Lab/add_template');?>" role="form">
                           <div class="row col-md-12">
                                <div class="col-md-3">
								<div class="form-group">
                                    <label for="template_name" class="col-form-label">TEMPLATE NAME<span style="color:red;">*</span></label>
                                    <input id="template_name" name="template_name" type="text" placeholder="" class="form-control" required>
                                </div></div>															
